...
export const RESPONDER_CUESTIONARIO = '/cuestionarios/responder'
export const EDITAR_CUESTIONARIO = '/cuestionarios/editar'
export const CUESTIONARIO_CATEGORIA = '/cuestionarios/categoria'
